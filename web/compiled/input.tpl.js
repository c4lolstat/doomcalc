...
this["Handlebars"]["templates"]["web/templates/input.handlebars"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div id=\"content\">\r\n<button class=\"clickable buttonsmall\" onclick=\"doom.setLanguage('en')\" value=\"en\" >EN</button>\r\n<button class=\"clickable buttonsmall\" onclick=\"doom.setLanguage('ru')\" value=\"ru\" >RU</button>\r\n<br/>\r\n    <div id=\"maininput\">\r\n"
    ...
    + "        <p><label for=\"summonerName\"><%_name%></label><input type=\"text\" id=\"summonerName\" value=\""
    ...
    + "\" name=\"summonerName\" /></p>\r\n        <p><label for=\"region\"><%_region%> </label><input type=\"text\" id=\"region\" value=\""
    ...
    + "\" name=\"region\" /></p>\r\n        <p><input type=\"checkbox\" id=\"rememberme\" ><label for=\"rememberme\"><%_remember%></label></p>\r\n        <button class=\"clickable button\" onclick=\"doom.eventAgg.trigger('input:getTeam')\" value=\"Match me with retards!\" ><%_inputbutton%></button>\r\n    </div>\r\n    <div id=\"endorse\">\r\n        <span>This software  isn’t endorsed by Riot Games and doesn’t reflect the views or opinions of Riot Games or anyone officially involved in producing or managing League of Legends. League of Legends and Riot Games are trademarks or registered trademarks of Riot Games, Inc. League of Legends © Riot Games, Inc.</span>\r\n    </div>\r\n</div>\r\n";
},"useData":true});